...
mixin _$EditAccountStore on _EditAccountStore, Store {
  ...
  final _$savedUserAtom = Atom(name: '_EditAccountStore.savedUser');

  @override
  bool get savedUser {
    _$savedUserAtom.reportRead();
    return super.savedUser;
  }

  @override
  set savedUser(bool value) {
    _$savedUserAtom.reportWrite(value, super.savedUser, () {
      super.savedUser = value;
    });
  }
